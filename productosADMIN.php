...
<head>
    ...
    <title>CIYSE - Admin Productos</title>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td><img src="../../img/producto1.jpg" alt="Producto" height="50"></td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-vino">Guardar Producto</button>
                </div>
            </div>
        </div>
    </div>
